...
function createSkAPISearch(div)
  ...
  table.insert(content,
    ...
    <div x-data="apiSearch">
      ...
      <div class="modal-overlay" x-show="showModal" @click.self="closeModal" x-cloak>
        <div class="modal-content" @click.stop>
          <div class="modal-card">
            <div class="modal-toolbar">
              ...
              <label title="Показать необязательные параметры">
                <input type="checkbox" value="optParams" x-model="visFilter">
              ...
              <label title="Показать типы">
                <input type="checkbox" value="typeHints" x-model="visFilter">
              ...
              <label title="Показать диаграмму">
                <input type="checkbox" value="blackBox" x-model="visFilter">
          ...
          <template x-if="selectedItem">
            <div style="overflow-y: auto;">
              ...
              <div x-show="visFilter.includes('blackBox')" class="blackbox">
                ...
                <div class="blackbox__output">
                  <div x-show="selectedItem.returns.type !== 'None'">
                    <code
                    x-text="visFilter.includes('typeHints') ? selectedItem.returns.type : '&nbsp;'"></code>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <code 
                    x-show="visFilter.includes('typeHints')" 
